                ...
                service.actualizarUsuario(Datainfo.resultLogin.getToken_type() + " " + Datainfo.resultLogin.getAccess_token(), nuevoNombre, nuevoApellido, nuevoEmail, nuevoTelefono)
                    ...
                    @Override
                        ...
                        if (response.isSuccessful()) {
                            Toast.makeText(EditUser.this, "Datos actualizados con exito", Toast.LENGTH_SHORT).show();
                            finish();

                        } else {
                            Toast.makeText(EditUser.this, "Error al actualizar datos", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<RespuestaLogin> call, Throwable t) {
                        ...
                        Toast.makeText(EditUser.this, "Error de conexion", Toast.LENGTH_SHORT).show();
                    }
                });
