...
public class InfoAlquilerSolicitado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_alquiler_solicitado);
        ...
        if ("Aceptado".equals(estado) || "Solicitud".equals(estado) || "Rechazado".equals(estado) || "Finalizado".equals(estado) || "Entregado_usuario".equals(estado)) {
