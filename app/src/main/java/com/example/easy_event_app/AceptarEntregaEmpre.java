...
public class AceptarEntregaEmpre extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aceptar_entrega_empre);
        ...
        btnRechazar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(AceptarEntregaEmpre.this);
                builder.setTitle("Aceptar entrega");
                builder.setMessage(Html.fromHtml("Estas seguro que deseas aceptar la entrega?, no podras devolver los cambios"));
